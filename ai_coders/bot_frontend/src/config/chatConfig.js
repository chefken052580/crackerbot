...
// Version: v2025-07-29-01
/**
 * Configuration for CrackerBot's chat interface.
 * Defines available commands and color schemes for the frontend.
 *
...
export const commands = [
  ...
  { command: "/warp_reconnect", description: "Reset user state and prompt for a new name" },
